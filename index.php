  ...
  <div class="container text-center">
    ...
    <div class="row py-5">
      ...
      <div class="col-sm-12 col-lg-4">
        ...
        <p>We aim to be not just a furniture company, but a conduit of empowerment,
           channeling the profits from our handcrafted rattan pieces into the hands 
           of the talented indigenous communities who create them.
        </p>
      </div>
      <div class="col-sm-12 col-lg-4">
        <h2>Our Impact</span></h2>
        <img src="assets/image/6.png" style="width:70%"></img>
        <p>By choosing Ecotribe, you're empowering indigenous communities. 
            Each purchase directly supports these skilled artisans, preserving their
           cultural heritage and providing sustainable livelihoods. 
        </p>
      </div>
    </div>
  </div>
